...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{%
        \includegraphics[width=0.90\textwidth]{images/usecase/footballosgeneralusecase.drawio (1).png}%
    }
...
\begin{figure}[H]
\centering
\includegraphics[width=0.92\textwidth, height=0.30\textheight, keepaspectratio]{images/usecase/player-profile-consultation-use-case.png}
