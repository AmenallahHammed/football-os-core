...
\noindent The governance class diagram represents the administrative and canonical part
...
Figure~\ref{fig:governance-class-diagram} shows the main governance entities.
Actors represent platform
...
The main classes represented in this diagram are Actor, Role, Player, Team,
and AuditLogEntry. This model clarifies how identity, authorization
references, canonical entities, and audit traceability are structured in the
governance domain.
...
\centering
\makebox[\textwidth][c]{%
\includegraphics[width=1.24\textwidth,height=0.92\textheight,keepaspectratio]{images/class-dig-governance.png}%
}
\caption{Governance class diagram}
...
\begin{figure}[H]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.24\textwidth,height=0.92\textheight,keepaspectratio]{images/document-class-dig.png}}
...
\centering
\makebox[\textwidth][c]{%
  \includegraphics[width=0.96\textheight,height=1.36\textwidth,keepaspectratio,angle=-90]{images/calander-event-class-dig.png}
}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth,height=0.52\textheight,keepaspectratio]{images/auth-seq.png}
