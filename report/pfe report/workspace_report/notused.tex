...
\subsection{Microservices-Oriented Monorepo}

Football OS follows a microservices-oriented architecture organized in a
monorepo where each backend service owns its data and business logic.
This separation allows components to evolve independently and reduces
